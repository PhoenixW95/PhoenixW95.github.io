...
## Catalog
0. [Linux系统下 Jekyll 的搭建](#Linux系统下 Jekyll 的搭建)
1. [Ruby](#Ruby)
2. [Change the Gem's sources](#Change the Gem's sources)
3. [Install the Jekyll](#Install the Jekyll)
4. [Build your firstblog](#Build your firstblog)
5. [用GitHub展示你的博客](#用GitHub展示你的博客)
6. [绑定域名](#绑定域名)
7. [制作属于你的Blog](#制作属于你的Blog)
8. [参考资料](#参考资料)
...
<img class="shadow" width="550" src="/img/in-post/111.png" />
...
gem sources -u
```
<img class="shadow" width="650" src="/img/in-post/112.png" />
...
<img class="shadow" width="650" src="/img/in-post/113.png" />
...
<img class="shadow" width="1000" src="/img/in-post/114.png" />
